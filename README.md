...
- If your projects are hosted on Github, in fact, Github already has an amazing tool to see which of your dependencies are searching for funding, check it out [here](https://github.com/sponsors/community).
