...
const PrivacyContent = () => (
  <>
    <h2>Privacy Policy for Sponsorhello</h2>
    <p>
      At Sponsorhello, accessible from
      [https://sponsorhello.org](https://sponsorhello.org), one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by
      Sponsorhello and how we use it. If you have additional questions or
      require more information about our Privacy Policy, do not hesitate to
      contact us. This Privacy Policy applies only to our online activities and
      is valid for visitors to our website with regards to the information that
      they shared and/or collect in Sponsorhello. This policy is not applicable
    ...
    <p>
      The personal information that you may asked to provide, and the reasons
    ...
    <h3>Log Files</h3>
    <p>
      Sponsorhello follows a standard procedure of using log files. These files
      ...
      trends, administering the site, tracking users&apos;s movement on the
      website, and gathering demographic information.
    </p>
    <h3>Advertising Partners Privacy Policies</h3>
    <p>
      You may consult this list to find the Privacy Policy for each of the
      advertising partners of Sponsorhello. Third-party ad servers or ad
      ...
      Sponsorhello, which are sent directly to users&apos; browser. They
      ...
      that you visit. Note that Sponsorhello has no access to or control over
      these cookies that are used by third-party advertisers.
    </p>
    <h3>Third Party Privacy Policies</h3>
    <p>
      Sponsorhello&apos;s Privacy Policy does not apply to other advertisers or
      ...
      with specific web browsers, it can be found at the browsers&apos;s
      respective websites.
    </p>
    ...
    <p>
      ...
      in, and/or monitor and guide their online activity. Sponsorhello does not
...
export const CookieBanner: React.VFC = () => {
  ...
  const toggleExpanded = (state: boolean) => {
  ...
  return (
    <>
      ...
      >
        ...
        <CloseIcon className={styles.closeIcon} onClick={closeCookieBanner} />
      </Card>
      <div
        className={clsx(styles.overlay, expanded && styles.overlayVisible)}
